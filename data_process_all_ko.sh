...
## 실행할 Python 스크립트 목록
scripts=("insert_category_info.py --data_type major" "insert_category_info.py --data_type theme" "insert_busan_info.py --mode all" "insert_tour_meta.py --mode all" "insert_tour_meta.py --mode error_samples" "insert_tour_vector.py --mode all" "insert_tour_distance.py --mode all" "insert_review.py --mode all")
